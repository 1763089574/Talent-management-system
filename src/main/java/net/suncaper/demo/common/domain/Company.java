...
import net.suncaper.demo.common.domain.extend.CompanyExtend;

public class Company extends CompanyExtend {
    /**
     *
     ...
     * @mbg.generated Mon Mar 01 19:03:20 CST 2021
     */
    public Company(Integer id, String name, String phonenumber, String password, Integer flag, Integer credit, String licensenumber) {
        this.id = id;
        this.name = name;
